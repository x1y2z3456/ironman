...
還記得我們之前提過的helloworld應用嗎？這是[第三天](https://github.com/x1y2z3456/ironman/blob/master/day3)minikube的內容，那個時候我們需要去做port forwarding才能驗證我們pod裡面的網頁helloworld，那個時候有提到可以不用這麼麻煩，今天我們就來解開這個神秘的面紗。
